...
const OrderItems = () => {
  ...
  return (
    <>
      ...
      <div className='lg:flex sm:flex sm:flex-col lg:justify-center dark:border-none lg:border-slate-100 lg:border  sm:justify-center lg:items-center sm:items-start w-full h-[40rem] lg:h-[25rem] '>
        <div className='lg:grid border-black border sm:border sm:border-slate-300 sm:rounded lg:border-none flex flex-col justify-center items-center gap-1 lg:gap-3  lg:grid-cols-3 sm:ml-4 sm:w-11/12 lg:w-3/4 my-2 lg:my-6'>

          <div className='rounded w-11/12 dark:border-none dark:bg-slate-900 lg:border lg:border-slate-200  lg:col-span-2 '>
            <div className='font-bold  h-7 lg:font-bold text-[16px] pt-2 sm:pb-2 sm:mb-2.5 lg:pb-9 pl-2 lg:text-lg lg:pl-2'>Shipping</div>
            <div className='lg:flex flex '><p className='lg:pl-2 lg:text-base  text-blue-600 lg:text-blue-600 text-[13px] pt-1 pb-2 pl-2 font-medium lg:font-medium'>Address :</p>
              <p className='text-[13px] lg:text-sm pb-2 lg:pt-2 sm:pt-0.5 pl-2'>{cart.shipping.address},{cart.shipping.city},{cart.shipping.country}</p>
            </div>
          </div>

          <div className='lg:border dark:border-none dark:bg-slate-900 rounded w-11/12 lg:border-b-2 lg:border-slate-200 lg:col-span-2 '>
          ...
          <div className='rounded w-11/12 lg:pb-2 mt-2 lg:mt-0 lg:border dark:border-none dark:lg:bg-slate-900 dark:bg-slate-900 dark:lg:text-white dark:text-white flex flex-col justify-center items-center lg:border-slate-200 lg:col-span-2 lg:row-start-3 '>
            ...
            <div className='lg:flex lg:w-full lg:pb-2 pb-2 w-full flex lg:border-none'>
              <div className='lg:w-full w-full'>
                {cart.cartItems.length === 0 ? <div className='flex justify-center items-center'><p className=' w-3/4 border dark:border-none  py-3 border-zinc-200 flex justify-center items-center text-red-700 font-medium'>Your cart is empty</p></div> :
          ...
          <div className='lg:w-[20rem] w-3/5 h-[10.5rem] lg:h-[13rem] mb-3 lg:mb-0 mt-2 lg:mt-0  lg:ml-4 lg:col-start-3 dark:border-none dark:bg-slate-900 dark:text-white dark:lg:bg-slate-900 dark:lg:text-black lg:row-end-4 lg:row-start-1 flex lg:flex justify-center lg:justify-center items-center lg:items-center lg:border-2 lg:border-slate-200 rounded lg:rounded'>
            <div className='dark:text-white w-[13rem] h-[9rem] lg:h-[12.5rem] lg:flex flex justify-center lg:justify-center items-center lg:items-center'>
              <div className=''>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className='lg:px-1 px-2 lg:font-bold font-bold dark:text-cyan-400 text-cyan-400 lg:text-cyan-400'>{`${cart.totalPrice} ৳`}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
