...
const Footer=({style})=>{
  return (
    <>
    <div className='lg:w-full lg:h-52 lg:flex lg:flex-col lg:mt-20 lg:justify-center lg:items-center lg:bg-neutral-950 w-full  h-24 flex flex-col mt-3 justify-center items-center lg:outline-none outline-none bg-neutral-950' >
