    ...
    return (
        <div>
            <form className='flex items-center' action="" onSubmit={submit}>
                <div>
            <input type="search" name='search' className='outline-0 caret-black focus:ring-0 focus:ring-offset-1 focus:ring-black focus:ring-offset-black caret-blue-600 scroll:smooth text pl-4 rounded-l-md focus:ring-black focus:border-slate-800 w-[30rem] h-8' spellCheck={false} placeholder='search...' value={keyword} onChange={(e)=>setkeyword(e.target.value)}/>
            </div>
